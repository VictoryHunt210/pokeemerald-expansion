...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_VISE_GRIP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Grips the foe with mighty\n"
            "pincers. Always crits."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_RAGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hits 2-3 times before confusion."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_CONFUSE_RAY] =
    {
        ...
        .description = COMPOUND_STRING(
            "A sinister ray that always\n"
            "hits and lowers Speed."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_GHOST,
        .accuracy = 0,
...
=======
        ...
        #endif
        .effect = EFFECT_NON_VOLATILE_STATUS,
>>>>>>> 5cfab59209b695c3eb3f0bc5f77adbd745b190f0
        .power = 0,
        .type = TYPE_POISON,
        .pp = 40,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_WILL_O_WISP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Ghoulish Ghost-Fire flame\n"
            "attack that always hits."),
    ...
    [MOVE_GRASS_WHISTLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Lulls the foe into lowered\n"
            "Speed with a pleasant melody."),
        .effect = EFFECT_SPEED_DOWN,
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_AERIAL_ACE] =
    {
        ...
        .description = COMPOUND_STRING(
            "An extremely speedy attack\n"
            "that always hits and crits."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_FLYING,
        .accuracy = 0,
    ...
    [MOVE_VOLT_TACKLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A life-risking tackle that\n"
            "hurts the user. May lower Speed."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_DARK_VOID] =
    {
        ...
        .description = COMPOUND_STRING(
            "Bypasses Protect and hits both."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_DARK,
        .accuracy = 0,
    ...
    [MOVE_SLUDGE_WAVE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "of sludge. May also lower Speed."),
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_INFERNO] =
    {
        ...
        .description = COMPOUND_STRING(
            "Powerful and might lower Attack."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_SIZZLY_SLIDE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Leaves the foe with lower Attack."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_SHELL_SIDE_ARM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "special damage. May lower Speed."),
    ...
    [MOVE_BARB_BARRAGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Powers up against statused foes."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = 65,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_G_MAX_VOLT_CRASH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Lowers opponents' Speed."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_GOLD_RUSH] =
    {
        ...
        .description = COMPOUND_STRING(
            "G-max Meowth attack.\n"
            "Raises team's Attack."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_SMITE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Lowers opponents' Sp. Def."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_FAIRY,
        .accuracy = 0,
